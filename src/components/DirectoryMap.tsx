...
export function DirectoryMap({ highlightedStallCode }: DirectoryMapProps) {
  ...
  const handleImageMapClick = (e: React.MouseEvent<HTMLImageElement>) => {
    ...
    const areas = [
      { coords: [189,225,26,226,25,195,10,193,10,16,192,16,193,47,225,48,226,187], type: 'poly' },
      { coords: [248,134,263,48], type: 'rect' },
      { coords: [239,225,189,225,226,187,252,212], type: 'poly' },
      { coords: [240,225,253,213,316,276,303,289], type: 'poly' },
      { coords: [298,180,307,190,382,190,382,230,362,230,334,202,294,203,285,193], type: 'poly' },
      { coords: [401,206,553,250], type: 'rect' },
      { coords: [409,287,396,277], type: 'rect' },
      { coords: [396,287,385,277], type: 'rect' },
      { coords: [396,276,386,264], type: 'rect' },
      { coords: [397,276,409,264], type: 'rect' },
      { coords: [435,276,423,264], type: 'rect' },
      { coords: [435,276,448,265], type: 'rect' },
      { coords: [459,276,448,264], type: 'rect' },
      { coords: [472,276,460,264], type: 'rect' },
      { coords: [424,288,434,277], type: 'rect' },
      { coords: [435,288,448,277], type: 'rect' },
      { coords: [459,287,449,276], type: 'rect' },
      { coords: [472,288,459,276], type: 'rect' },
      { coords: [474,332,426,302], type: 'rect' },
      { coords: [576,278,537,277,515,300,515,330,576,331], type: 'poly' },
    ];
